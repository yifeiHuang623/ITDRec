...
class SASRec(torch.nn.Module):
    def __init__(self, user_num, item_num, args):
        ...
        self.pos_emb = torch.nn.Embedding(args.max_input_sequence_length, args.node_feat_dim)
        ...
        for _ in range(args.num_layers):
            ...
            new_attn_layer =  torch.nn.MultiheadAttention(args.node_feat_dim,
                                                            args.num_heads,
                                                            args.dropout)
    ...
    def log2feats(self, log_seqs):
        ...
        tl = seqs.shape[1]
        # Upper triangular matrix, mask future information
